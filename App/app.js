...
os.controller("MainCtr", ['$scope', '$rootScope', '$state', '$http', '$sce', function ($scope, $rootScope, $state, $http, $sce) {
    ...
    $scope.GetBaoCao = function (d) {
        $http({
            method: "POST",
            url: "Home/GetBaoCao",
            data: { diadanhid: d.Diadanh_ID, fromDate: $scope.fromDate, toDate: $scope.toDate, isDuBao: false },
            contentType: 'application/json; charset=utf-8'
        }).then(function (res) {
            if (res.data.error !== 1) {
    ...
    //$scope.GetBodyBaoCao = function (d) {
    //    $http({
    //        method: "POST",
    //        url: "Home/GetBodyBaoCao",
    //        data: { diadanhid: d.Diadanh_ID, fromDate: $scope.fromDate, toDate: $scope.toDate, bd: true },
    //        contentType: 'application/json; charset=utf-8'
    //    }).then(function (res) {
    //        if (res.data.error !== 1) {
