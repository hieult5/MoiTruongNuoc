...
os.controller("MainCtr", ['$scope', '$rootScope', '$state', '$http', '$sce', function ($scope, $rootScope, $state, $http, $sce) {
    ...
    $scope.GetBaoCao = function (d) {
        $http({
            ...
            url: "Home/GetBaoCao",
            data: {
                diadanhid: d.Diadanh_ID, fromDate: $scope.Search.fromDate == null ? null : moment($scope.Search.fromDate).format("DD/MM/YYYY"), toDate: $scope.Search.toDate == null ?
                null : moment($scope.Search.toDate).format("DD/MM/YYYY"), isDuBao: false
            },
            contentType: 'application/json; charset=utf-8'
        }).then(function (res) {
            if (res.data.error !== 1) {
    ...
    $scope.FilterBaoCao = function () {
        $http({
            ...
            url: "Home/GetBaoCao",
            data: {
                diadanhid: $scope.diadanhid, fromDate: $scope.Search.fromDate == null ? null : moment($scope.Search.fromDate).format("DD/MM/YYYY"), toDate: $scope.Search.toDate == null ?
                null : moment($scope.Search.toDate).format("DD/MM/YYYY"), isDuBao: false },
            contentType: 'application/json; charset=utf-8'
        }).then(function (res) {
            if (res.data.error !== 1) {
    ...
    $scope.ExportExcel = function () {
        $http({
            ...
            data: JSON.stringify(
                {
                    fromDate: $scope.Search.fromDate == null ? null : moment($scope.Search.fromDate).format("DD/MM/YYYY"),
                    toDate: $scope.Search.toDate == null ? null : moment($scope.Search.toDate).format("DD/MM/YYYY"),
                    isDuBao: false,
                    id: $scope.diadanhid,
                }),
            contentType: 'application/json; charset=utf-8'
